...
import org.example.proxy.model.entity.order.OrderProfitsharing;
import org.example.proxy.model.entity.order.OrderStatusLog;
import org.example.proxy.model.enums.OrderStatus;
import org.example.proxy.model.form.order.OrderInfoForm;
import org.example.proxy.model.form.order.StartDriveForm;
import org.example.proxy.model.form.order.UpdateOrderBillForm;
import org.example.proxy.model.form.order.UpdateOrderCartForm;
import org.example.proxy.model.vo.base.PageVo;
import org.example.proxy.model.vo.order.*;
import org.example.proxy.order.mapper.OrderBillMapper;
import org.example.proxy.order.mapper.OrderInfoMapper;
import org.example.proxy.order.mapper.OrderProfitsharingMapper;
import org.example.proxy.order.mapper.OrderStatusLogMapper;
import org.example.proxy.order.service.OrderInfoService;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    private void sendDelayMessage(Long orderId) {
        try{
            ...
            e.printStackTrace();
            throw new ProxyException(ResultCodeEnum.DATA_ERROR);
        }
    }
    ...
    public Boolean robNewOrder(Long driverId, Long orderId) {
        ...
        if(!redisTemplate.hasKey(RedisConstant.ORDER_ACCEPT_MARK)) {
            //抢单失败
            throw new ProxyException(ResultCodeEnum.COB_NEW_ORDER_FAIL);
        }
    ...
    public Boolean driverArriveStartLocation(Long orderId, Long driverId) {
        ...
        if(rows == 1) {
            ...
            throw new ProxyException(ResultCodeEnum.UPDATE_ERROR);
        }
    }
