...
import org.example.proxy.model.vo.system.MetaVo;
import org.example.proxy.model.vo.system.RouterVo;
import org.example.proxy.system.helper.MenuHelper;
import org.example.proxy.system.mapper.SysMenuMapper;
import org.example.proxy.system.mapper.SysRoleMenuMapper;
import org.example.proxy.system.service.SysMenuService;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public boolean removeById(Serializable id) {
        ...
        if (count > 0) {
            throw new ProxyException(ResultCodeEnum.NODE_ERROR);
        }
