...
import org.example.proxy.common.constant.SystemConstant;
import org.example.proxy.common.exception.ProxyException;
import org.example.proxy.common.result.ResultCodeEnum;
import org.example.proxy.common.util.LocationUtil;
import org.example.proxy.driver.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Boolean endDrive(OrderFeeForm orderFeeForm) {
        ...
        if(orderInfo.getDriverId() != orderFeeForm.getDriverId()) {
            throw new ProxyException(ResultCodeEnum.ILLEGAL_REQUEST);
        }
...
//        }
    ...
    public Boolean endDriveThread(OrderFeeForm orderFeeForm) {
        ...
        double distance = LocationUtil.getDistance(orderInfo.getEndPointLatitude().doubleValue(),
                ...
                orderServiceLastLocationVo.getLongitude().doubleValue());
        if(distance > SystemConstant.DRIVER_END_LOCATION_DISTION) {
            throw new ProxyException(ResultCodeEnum.DRIVER_END_LOCATION_DISTION_ERROR);
        }
    ...
    public Boolean driverArriveStartLocation(Long orderId, Long driverId) {
        ...
        if(distance > SystemConstant.DRIVER_START_LOCATION_DISTION) {
            throw new ProxyException(ResultCodeEnum.DRIVER_START_LOCATION_DISTION_ERROR);
        }
